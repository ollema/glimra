...
pub fn kotlin_tests() {
  describe("kotlin expected tokens snippet validation", [
    it("validates with catppuccin-mocha theme", fn() {
      test_helpers.validate_snippet(languages.Kotlin, "snippet", themes.CatppuccinMocha)
    }),
    ...
    it("validates with github-dark theme", fn() {
      test_helpers.validate_snippet(languages.Kotlin, "snippet", themes.GithubDark)
    }),
    it("validates with gruvbox-dark-medium theme", fn() {
      test_helpers.validate_snippet(languages.Kotlin, "snippet", themes.GruvboxDarkMedium)
    }),
    ...
    it("validates with night-owl theme", fn() {
      test_helpers.validate_snippet(languages.Kotlin, "snippet", themes.NightOwl)
    }),
    ...
    it("validates with one-dark-pro theme", fn() {
      test_helpers.validate_snippet(languages.Kotlin, "snippet", themes.OneDarkPro)
    }),
    it("validates with tokyo-night theme", fn() {
      test_helpers.validate_snippet(languages.Kotlin, "snippet", themes.TokyoNight)
    }),
    it("validates with vitesse-dark theme", fn() {
      test_helpers.validate_snippet(languages.Kotlin, "snippet", themes.VitesseDark)
    }),
  ])
}
