...
pub fn r_tests() {
  describe("r expected tokens snippet validation", [
    ...
    it("validates with night-owl theme", fn() {
      test_helpers.validate_snippet(languages.R, "snippet", themes.NightOwl)
    }),
    it("validates with nord theme", fn() {
      test_helpers.validate_snippet(languages.R, "snippet", themes.Nord)
    }),
    it("validates with one-dark-pro theme", fn() {
      test_helpers.validate_snippet(languages.R, "snippet", themes.OneDarkPro)
    }),
    it("validates with tokyo-night theme", fn() {
      test_helpers.validate_snippet(languages.R, "snippet", themes.TokyoNight)
    }),
    it("validates with vitesse-dark theme", fn() {
      test_helpers.validate_snippet(languages.R, "snippet", themes.VitesseDark)
    }),
  ])
}
...
pub fn r_recursion_tests() {
  describe("r expected recursion validation", [
    it("processes all patterns correctly", fn() {
      test_helpers.validate_expected_recursion(languages.R)
    }),
  ])
}
