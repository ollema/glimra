...
pub fn latex_generated_tests() {
  describe("latex expected generated validation", [
    it("generates all patterns correctly", fn() {
      test_helpers.validate_expected_generated(languages.Latex)
    }),
  ])
}

pub fn latex_recursion_tests() {
  describe("latex expected recursion validation", [
    it("processes all patterns correctly", fn() {
      test_helpers.validate_expected_recursion(languages.Latex)
    }),
  ])
}
