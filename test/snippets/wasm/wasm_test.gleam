...
pub fn wasm_tests() {
  describe("wasm expected tokens snippet validation", [
    it("validates with catppuccin-mocha theme", fn() {
      test_helpers.validate_snippet(languages.Wasm, "snippet", themes.CatppuccinMocha)
    }),
    ...
    it("validates with github-dark theme", fn() {
      test_helpers.validate_snippet(languages.Wasm, "snippet", themes.GithubDark)
    }),
    it("validates with gruvbox-dark-medium theme", fn() {
      test_helpers.validate_snippet(languages.Wasm, "snippet", themes.GruvboxDarkMedium)
    }),
    ...
    it("validates with one-dark-pro theme", fn() {
      test_helpers.validate_snippet(languages.Wasm, "snippet", themes.OneDarkPro)
    }),
    it("validates with tokyo-night theme", fn() {
      test_helpers.validate_snippet(languages.Wasm, "snippet", themes.TokyoNight)
    }),
    it("validates with vitesse-dark theme", fn() {
      test_helpers.validate_snippet(languages.Wasm, "snippet", themes.VitesseDark)
    }),
  ])
}
...
pub fn wasm_regex_plus_ast_tests() {
  describe("wasm expected regex_plus_ast validation", [
    it("transforms all patterns correctly", fn() {
      test_helpers.validate_expected_regex_plus_ast(languages.Wasm)
    }),
  ])
}
