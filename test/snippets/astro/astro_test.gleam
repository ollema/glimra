...
pub fn astro_tests() {
  describe("astro expected tokens snippet validation", [
    it("validates with catppuccin-mocha theme", fn() {
      test_helpers.validate_snippet(languages.Astro, "snippet", themes.CatppuccinMocha)
    }),
    ...
    it("validates with github-dark theme", fn() {
      test_helpers.validate_snippet(languages.Astro, "snippet", themes.GithubDark)
    }),
    it("validates with gruvbox-dark-medium theme", fn() {
      test_helpers.validate_snippet(languages.Astro, "snippet", themes.GruvboxDarkMedium)
    }),
    ...
    it("validates with one-dark-pro theme", fn() {
      test_helpers.validate_snippet(languages.Astro, "snippet", themes.OneDarkPro)
    }),
    it("validates with tokyo-night theme", fn() {
      test_helpers.validate_snippet(languages.Astro, "snippet", themes.TokyoNight)
    }),
    it("validates with vitesse-dark theme", fn() {
      test_helpers.validate_snippet(languages.Astro, "snippet", themes.VitesseDark)
    }),
  ])
}
