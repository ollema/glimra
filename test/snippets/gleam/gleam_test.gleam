...
pub fn gleam_tests() {
  describe("gleam expected tokens snippet validation", [
    it("validates with catppuccin-mocha theme", fn() {
      test_helpers.validate_snippet(languages.Gleam, "snippet", themes.CatppuccinMocha)
    }),
    ...
    it("validates with github-dark theme", fn() {
      test_helpers.validate_snippet(languages.Gleam, "snippet", themes.GithubDark)
    }),
    it("validates with gruvbox-dark-medium theme", fn() {
      test_helpers.validate_snippet(languages.Gleam, "snippet", themes.GruvboxDarkMedium)
    }),
    ...
    it("validates with one-dark-pro theme", fn() {
      test_helpers.validate_snippet(languages.Gleam, "snippet", themes.OneDarkPro)
    }),
    it("validates with tokyo-night theme", fn() {
      test_helpers.validate_snippet(languages.Gleam, "snippet", themes.TokyoNight)
    }),
    it("validates with vitesse-dark theme", fn() {
      test_helpers.validate_snippet(languages.Gleam, "snippet", themes.VitesseDark)
    }),
  ])
}
